...
try:
    ...
    user_service_pb2.CreateUserRequest(name="Ghadeer Test", email="ghadeerhayek@gmail.com"))
    print("Create user response: ", create_user_response)
    update_user_response = stub.updateUser(
    user_service_pb2.UpdateUserRequest(id="1", name="previous example", email="emailremainsthesame"))
